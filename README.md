...
- **[CodingStandards](./CodeWhale/CodingStandards/SKILL.md)** — 工程编码规范。团队级编码约束集，覆盖数据库规范（逻辑删除/主键策略）、代码风格（纯度标记/命名/异常/日志）、测试架构（影响面/覆盖/模块化/复用优先）、Git 与安全（Commit 规范/操作禁令），共 16 条 P0 级硬约束。
